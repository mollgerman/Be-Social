...
import UserImage from "../../components/UserImage";
  ...
  const PostWidget = ({
    ...
    const getPostUserPicture = async () => {
        const userResponse = await fetch(`${import.meta.env.VITE_APP_SERVER_URL}/users/${postUserId}`,{
            headers: {
    ...
    const patchLike = async () => {
      const response = await fetch(`${import.meta.env.VITE_APP_SERVER_URL}/posts/${postId}/like`, {
        method: "PATCH",
        headers: {
          Authorization: `Bearer ${ token }`,
    ...
    const patchComment = async () => {
      const response = await fetch(`${import.meta.env.VITE_APP_SERVER_URL}/posts/${postId}/comment`, {
        method: "PATCH",
        headers: {
          Authorization: `Bearer ${ token }`,
        },
    ...
    const deletePost = async () => {
      const response = await fetch(`${import.meta.env.VITE_APP_SERVER_URL}/posts/post`, {
        method: "DELETE",
        headers: {
          Authorization: `Bearer ${ token }`,
          "Content-Type": "application/json",
