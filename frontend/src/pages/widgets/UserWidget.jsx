import {
  ...
  import { Box, Typography, Divider, useTheme, IconButton, Input } from "@mui/material";
  ...
  const UserWidget = ({ user_id }) => {
    ...
    const handleEditing = async () => {
      setIsEditing(false) //set to false until further project expansion
    }
